...
func TestBatchCancelMidBatch(t *testing.T) {
	...
	// Send cancel after a short delay. The signal is buffered by Temporal
	// and picked up when the workflow reaches a Select with OnSend.
	...
	t.Logf("Batch cancel: processed=%d out of 10000", result.Processed)
}
